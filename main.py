...
if place:
    try:
        ...
        if option == "Temperature":
            ...
            dates = [dict["dt_txt"][0:11] for dict in filtered_data]
        ...
        if option == "Sky":
            ...
            image_captions = [dict["dt_txt"] for dict in filtered_data]

            st.image(image=image_paths, caption=image_captions, width=115)
